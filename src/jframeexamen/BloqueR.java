...
public class BloqueR extends Base {
    ...
    public void cambiaimagen(int gp) {
        if (gp == 1) {
            Image bueno1;
            bueno1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("pill/red pill 2.png"));
            animacion = new Animacion();
            animacion.sumaCuadro(bueno1, 100);
        }
        if (gp == 2) {
            Image bueno1;
            bueno1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("pill/red pill 3.png"));
            animacion = new Animacion();
            animacion.sumaCuadro(bueno1, 100);
        }
    }
